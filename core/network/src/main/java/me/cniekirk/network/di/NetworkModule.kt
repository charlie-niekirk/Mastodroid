package me.cniekirk.network.di
...
import me.cniekirk.network.util.HostSelectionInterceptor
...
class NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideMastodonService(@Named("mastodon") retrofit: Retrofit): me.cniekirk.network.service.MastodonService =
        retrofit.create(MastodonService::class.java)

    @Provides
    @Singleton
    fun provideInstancesService(@Named("instances") retrofit: Retrofit): me.cniekirk.network.service.InstancesService =
